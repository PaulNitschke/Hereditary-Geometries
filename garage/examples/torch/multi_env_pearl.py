...
wandb.init(project="PEARL_point_env",
           entity="pnitschke",
           name="VanillaConfig",
...
def pearl_point_env(ctxt=None,
                             ...
                             num_train_tasks=default_config["num_train_tasks"],
                             num_test_tasks=default_config["num_test_tasks"],
                             latent_size=default_config["latent_size"],
                             encoder_hidden_size=default_config["encoder_hidden_size"],
                             net_size=default_config["net_size"],
                             meta_batch_size=default_config["meta_batch_size"],
                             num_steps_per_epoch=default_config["num_steps_per_epoch"],
                             num_initial_steps=default_config["num_initial_steps"],
                             num_tasks_sample=default_config["num_tasks_sample"],
                             num_steps_prior=default_config["num_steps_prior"],
                             num_extra_rl_steps_posterior=default_config["num_extra_rl_steps_posterior"],
                             batch_size=default_config["batch_size"],
                             embedding_batch_size=default_config["embedding_batch_size"],
                             embedding_mini_batch_size=default_config["embedding_mini_batch_size"],
                             reward_scale=default_config["reward_scale"],
                             max_episode_length=default_config["max_episode_length"],
