...
default_config={
    ...
    "n_policy_optimization_steps": 50,
    "n_contrastive_learning_optimization_steps": 200
}

custom_config={
    "num_train_tasks": 4,
    "n_policy_optimization_steps": 20,
}
...
def CL_point_env(ctxt=None,
                             ...
                             n_policy_optimization_steps=config["n_policy_optimization_steps"],
                             n_contrastive_learning_optimization_steps=config["n_contrastive_learning_optimization_steps"]):
    ...
    clmeta = CLMETA(
        ...
        # n_policy_optimization_steps=n_policy_optimization_steps,
        # n_contrastive_learning_optimization_steps=n_contrastive_learning_optimization_steps,
